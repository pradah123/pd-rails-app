...
ActiveRecord::Schema[7.0].define(version: 2023_09_25_093629) do
  ...
  create_table "contests", force: :cascade do |t|
    ...
    t.boolean "fetch_neighboring_region_data", default: true, null: false
    t.string "goe_text"
    t.string "goe_url"
  ...
  create_table "observations", force: :cascade do |t|
    ...
    t.string "civilization_profile_pic"
    t.index ["accepted_name"], name: "index_observations_on_accepted_name"
    t.index ["civilization_id"], name: "index_observations_on_civilization_id"
    t.index ["civilization_name"], name: "index_observations_on_civilization_name"
    t.index ["creator_name"], name: "index_observations_on_creator_name"
    t.index ["license_code"], name: "index_observations_on_license_code"
    t.index ["observed_at"], name: "index_observations_on_observed_at"
    t.index ["observed_at"], name: "index_observed_at_desc", order: :desc
  ...
  create_table "old_observations_regions", id: false, force: :cascade do |t|
    t.bigint "id"
    t.bigint "region_id"
    t.bigint "observation_id"
    t.timestamptz "created_at"
    t.timestamptz "updated_at"
    t.text "data_source_name"
  end
  ...
  create_table "regions", force: :cascade do |t|
    ...
    t.float "total_vs_greater_region_observations_score"
    t.float "total_vs_locality_observations_score"
    t.float "this_year_vs_total_observations_score"
    t.float "last_2years_vs_total_observations_score"
    t.float "total_vs_greater_region_species_score"
    t.float "total_vs_locality_species_score"
    t.float "this_year_vs_total_species_score"
    t.float "last_2years_vs_total_species_score"
    t.float "total_vs_greater_region_activity_score"
    t.float "total_vs_locality_activity_score"
    t.float "this_year_vs_total_activity_score"
    t.float "last_2years_vs_total_activity_score"
    ...
    t.float "polygon_area", default: 0.0
