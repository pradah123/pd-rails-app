class UpdateMatviewForParticipationSpecies < ActiveRecord::Migration[7.0]
  def up
    execute <<-SQL
      DROP MATERIALIZED VIEW IF EXISTS participation_species_matview
    SQL
    execute <<-SQL
      ...
      ( 
        SELECT t1.participation_id, t1.scientific_name, t2.species_count, t1.common_name,
               t1.accepted_name, t1.image, t1.taxonomy_id, t1.canonical_name, t1.kingdom,
               t1.class_name, t1.phylum, t1.order, t1.family, t1.genus
        FROM 
        (
    ...
    add_index :participation_species_matview, :taxonomy_id, name: 'index_participation_species_matview_taxonomy_id'
    add_index :participation_species_matview, :kingdom, name: 'index_participation_species_matview_kingdom'
    add_index :participation_species_matview, :class_name, name: 'index_participation_species_matview_on_class_name'
    add_index :participation_species_matview, :phylum, name: 'index_participation_species_matview_on_phylum'
    add_index :participation_species_matview, :order, name: 'index_participation_species_matview_on_order'
    add_index :participation_species_matview, :family, name: 'index_participation_species_matview_on_family'
    add_index :participation_species_matview, :genus, name: 'index_participation_species_matview_on_genus'
    add_index :participation_species_matview, [:participation_id, :scientific_name], unique: true, name: 'index_participation_species_matview_on_p_id_scientific_name'
  end
end
